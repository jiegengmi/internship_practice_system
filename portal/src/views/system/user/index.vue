        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.userId === undefined" label="用户密码" prop="password">
              <el-input v-model="form.password" autocomplete='off' placeholder="请输入用户密码" type="password"
...
function importTemplate() {
  proxy.download("/user/excel/template", {}, `user_template_${new Date().getTime()}.xlsx`);
}
/**文件上传中处理 */
